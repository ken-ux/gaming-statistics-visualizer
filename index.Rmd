...
We are interested in gaming as a domain because it explores a realm of technology that has gained traction and popularity over time, producing complex and interesting advancements in elements such as gaming platforms, companies, and technological innovations (VR, mobile, etc.) Our group has played different video games throughout our lives and it would be interesting to see how our perspective of its evolution parallels trends we uncover. Our datasets, sourced  [here](https://www.kaggle.com/jummyegg/rawg-game-dataset/data) and [here](https://www.kaggle.com/ashaheedq/video-games-sales-2019) from Kaggle, contains information such as achievements, genre, Metacritic ratings, and sales for thousands of titles.
